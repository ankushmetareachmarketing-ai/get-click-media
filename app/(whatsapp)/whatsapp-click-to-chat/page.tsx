...
const PLACEMENTS = [
  ...
  { icon: Instagram, place: "Instagram & Facebook Bio", lift: "15–25% of bio clicks go to WhatsApp" },
...
export default function WhatsAppClickToChatPage() {
  return (
    <>
      ...
      {/* ── HERO + GENERATOR ─────────────────────────────────────────────── */}
      <section id="link-generator" className="relative overflow-hidden bg-gradient-to-br from-[#0c1a3a] via-[#1e3a8a] to-[#1e40af] mx-1 sm:mx-2 rounded-2xl sm:rounded-3xl">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 text-center lg:text-left space-y-6">
              ...
              <p className="text-white/70 text-base sm:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0">
                A wa.me link opens a WhatsApp conversation with your business — no number saving, no searching,
                no friction. One tap and the customer is talking to you.
              </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="rounded-2xl border-l-4 border-[#2563eb] bg-blue-50/60 px-6 py-5">
            <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
              WhatsApp Click to Chat (also called a wa.me link or WhatsApp direct link) is a URL that opens a
              WhatsApp conversation with a specific phone number when clicked — without the sender needing to
              save the number first. The link format is https://wa.me/[phone number] and can include a
              pre-filled message. Click to Chat links can be placed on websites, in emails, in social media bios,
              on business cards, and in QR codes.
            </p>
          </div>
        </div>
      </section>
...
// URL encoding: Space = %20 | Comma = %2C | Apostrophe = %27`}</pre>
          ...
          <p className="text-sm text-gray-500 mt-8 leading-relaxed">
            <strong className="text-gray-800">WhatsApp QR Code:</strong> useful for business cards, packaging,
            and desktop placement. Generate the official version in WhatsApp Business App → Settings →
            Business Tools → Short Link, or via Meta Business Manager for API accounts — or just use the
            ...
            <table className="w-full text-sm min-w-[520px]">
              <thead>
                <tr className="bg-[#0f172a] text-white text-xs uppercase tracking-wider">
                  ...
                  <th className="text-left px-4 py-4 font-semibold">Customer Effort</th>
                  <th className="text-left px-4 py-4 font-semibold text-[#38bdf8]">Drop-off Rate</th>
                </tr>
              </thead>
              <tbody>
                <tr className="bg-white">
                  <td className="px-5 py-3.5 text-gray-700 font-medium">Ask customer to save number</td>
                  <td className="px-4 py-3.5 text-gray-500">High — save, find, open chat</td>
                  <td className="px-4 py-3.5 text-red-500 font-semibold">Very high — 60–80% never do it</td>
                </tr>
                <tr className="bg-gray-50">
                  <td className="px-5 py-3.5 text-gray-700 font-medium">wa.me Click to Chat link</td>
                  <td className="px-4 py-3.5 text-gray-500">Zero — one click opens chat</td>
                  <td className="px-4 py-3.5 text-green-600 font-semibold">Very low — under 5%</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <section className="py-20 sm:py-28 bg-white" id="placements">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {PLACEMENTS.map(p => (
              <div key={p.place} className="rounded-2xl bg-gray-50 border border-gray-100 p-6 space-y-2">
      ...
      <section className="py-20 sm:py-24 bg-white" id="with-api">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 space-y-4">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 font-(family-name:--font-syne)">
              Click to Chat + <Link href="/whatsapp-business-api" className="hover:underline underline-offset-4">WhatsApp Business API</Link>
            </h2>
          </div>
          <div className="overflow-x-auto rounded-2xl border border-gray-200 shadow-sm">
            <table className="w-full text-sm min-w-[600px]">
              <thead>
                <tr className="bg-[#0f172a] text-white text-xs uppercase tracking-wider">
                  ...
                  <th className="text-left px-4 py-4 font-semibold">Without API</th>
                  <th className="text-left px-4 py-4 font-semibold text-[#38bdf8]">With API + <Link href="/whatsapp-chatbot" className="hover:underline underline-offset-4">Chatbot</Link></th>
                </tr>
              </thead>
              <tbody>
                {WITH_WITHOUT.map((row, i) => (
                  <tr key={row.scenario} className={i % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                    <td className="px-5 py-3.5 text-gray-900 font-bold">{row.scenario}</td>
                    <td className="px-4 py-3.5 text-gray-500">{row.without}</td>
                    <td className="px-4 py-3.5 text-gray-800 font-medium">{row.with}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      <section className="py-20 sm:py-24 bg-gray-50" id="vs-ads">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 space-y-4">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 font-(family-name:--font-syne)">
              Click to Chat vs <Link href="/whatsapp-click-to-whatsapp-ads" className="hover:underline underline-offset-4">Click to WhatsApp Ads</Link>
            </h2>
          </div>
          <div className="overflow-x-auto rounded-2xl border border-gray-200 shadow-sm">
            <table className="w-full text-sm min-w-[520px]">
              <thead>
                <tr className="bg-[#0f172a] text-white text-xs uppercase tracking-wider">
                  ...
                  <th className="text-left px-4 py-4 font-semibold">Click to Chat</th>
                  <th className="text-left px-4 py-4 font-semibold text-[#38bdf8]">Click to WhatsApp Ads</th>
                </tr>
              </thead>
              <tbody>
                {VS_ADS.map((row, i) => (
                  <tr key={row.aspect} className={i % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                    ...
                    <td className="px-4 py-3.5 text-gray-800 font-medium">{row.ads}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-br from-[#0c1a3a] via-[#1e3a8a] to-[#1e40af] px-8 sm:px-16 py-16 text-center space-y-6">
            ...
            <div className="relative space-y-5">
              ...
              <p className="text-white/60 text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
                Free link generator · Pre-filled messages · Chatbot automation · CRM integration.
              </p>

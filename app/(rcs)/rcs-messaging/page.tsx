          ...
          <div className="flex flex-col lg:flex-row items-center gap-14">
            ...
            <div className="flex-1 space-y-6">
              ...
              <p className="text-gray-500 text-base leading-relaxed">
                ...
                >
                  GSMA&apos;s officially standardised
                </a>{" "}
                messaging protocol, and Google RCS Business Messaging is documented directly in{" "}
                <a
                  ...
                  className="text-[#2563eb] underline underline-offset-2"
                >
                  Google&apos;s Business Communications developer docs
                </a>
                .
              </p>
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-14 items-start">
            <div className="hidden lg:block lg:w-[36%] shrink-0 lg:sticky lg:top-24">
              <div className="relative w-full rounded-2xl overflow-hidden aspect-4/5">
                <Image
                  src="/images/rcs-hover.png"
                  alt="Ask a question about RCS messaging in India"
                  fill
                  className="object-cover"
                  sizes="36vw"
                />

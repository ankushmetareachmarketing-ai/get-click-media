...
const plans = [
  {
    ...
    cta: { label: "Get Started", type: "secondary" as const, href: "#" },
    highlighted: false,
  },
  {
    name: "Growth",
    ...
    cta: { label: "Get Free Demo", type: "primary" as const, href: null },
    highlighted: true,
  },
  {
    name: "Enterprise",
    ...
    cta: { label: "Contact Sales", type: "secondary" as const, href: "#" },
    highlighted: false,
  },
];

export default function TransactionalSmsPricing() {
  const { openModal } = useModalStore();

  return (
    <section
      aria-label="Transactional SMS pricing plans"
    ...
    >
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <h2 className="text-[1.75rem] sm:text-[2.25rem] md:text-[2.75rem] [font-family:var(--font-syne)] font-bold leading-[1.1] tracking-[-0.02em] text-(--ink-1) text-center mb-3">
          Transactional SMS Pricing for Indian Businesses
        </h2>
